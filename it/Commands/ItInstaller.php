...
class ItInstaller extends Command
{
    ...
    {
        shell_exec('composer require "laravelcollective/html":"^5.4.0"');
    ...
    private function yajra()
    {
        ...
        shell_exec('composer require yajra/laravel-datatables:^1.0');
    ...
    public function handle()
    {
        ...
        if (in_array($plugin, $this->plugins)) {
            if ($plugin == 'merge') {
                ...
                $this->merge();
            } elseif ($plugin == 'laravelcollective') {
                $this->laravelcollective();
            } elseif ($plugin == 'yajra') {
                $this->yajra();
            } elseif ($plugin == 'intervention') {
                $this->intervention();
            }
        } else {
            $plugg = [];
