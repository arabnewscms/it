...
class Generate extends Command {
	...
	public function handle() {
		...
		if (!empty(env('DB_DATABASE'))) {
			$auto_create_DB = $this->confirm("you want me a create database in your engine or you are already created database with name ".env('DB_DATABASE')."? ");
			if ($auto_create_DB) {
				...
				$this->info("DATABAES ".env('DB_DATABASE')." Created and is ready ");
			}
