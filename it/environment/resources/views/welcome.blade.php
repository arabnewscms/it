        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    return '#ef3b2d'.substr(0, 7 - hexString.length) + hexString;
                    };
                    ...
                    $(".logoit").css({fill: color, transition: "2.0s"});
                    }
                    $(function () {
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-1">
                    <div class="p-6">
                        ...
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"  width="100.000000pt" height="100.000000pt" viewBox="0 0 100.000000 100.000000"  preserveAspectRatio="xMidYMid meet">  <g transform="translate(0.000000,100.000000) scale(0.050000,-0.050000)"  fill="#7e8ca0b8" stroke="none"> <path d="M514 1484 l-494 -494 310 -310 310 -310 0 465 c0 256 3 465 7 465 4 0 35 -10 68 -21 42 -15 85 -15 133 -2 l72 20 0 -605 c0 -605 0 -605 46 -648 l46 -43 198 199 c183 184 195 200 144 200 -89 0 -205 70 -241 147 -28 60 -33 158 -33 718 0 868 60 845 -566 219z m386 116 c99 -99 18 -280 -124 -280 -131 0 -206 179 -115 276 54 58 183 60 239 4z"></path> <path d="M1360 1520 l0 -100 104 0 104 0 -98 100 c-54 55 -101 100 -104 100 -3 0 -6 -45 -6 -100z"></path> <path d="M1360 973 c0 -530 63 -561 415 -208 l225 226 -155 154 -156 155 -164 0 -165 0 0 -327z"></path>
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://it.phpanonymous.com" class="underline text-gray-900 dark:text-white"><b>A Simple Track To Make Sense</b></a></div>
                    </div>
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <a href="{{ aurl('') }}">Go To Admin Panel</a>
