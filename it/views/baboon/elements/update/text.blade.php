...
<div class="' . $data['col_width'] . '">
    <div class="form-group">
        ...
        {!! Form::text(\'{Convention}\', {Convention2} ,[\'class\'=>\'form-control\',\'placeholder\'=>trans(\'{lang}.{Convention}\')]) !!}
    </div>
</div>
';
} else {
...
<div class="' . $data['col_width'] . '">
    <div class="form-group">
        ...
        <input type="text" id="{Convention}" name="{Convention}" value="{{ {Convention2} }}" class="form-control" placeholder="{{trans(\'{lang}.{Convention}\')}}" />
    </div>
</div>
';
}
