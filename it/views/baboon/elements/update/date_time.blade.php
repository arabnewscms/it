...
<div class="' . $data['col_width'] . '">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text(\'{Convention}\', {Convention2} ,[\'class\'=>\'form-control float-right date_time_picker\',\'placeholder\'=>trans(\'{lang}.{Convention}\'),\'readonly\'=>\'readonly\']) !!}
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->
...
<div class="' . $data['col_width'] . '">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" name="{Convention}" value="{{ {Convention2} }}" class="form-control float-right date_time_picker" readonly="readonly" placeholder="{{trans(\'{lang}.{Convention}\')}}">
        </div>
        <!-- /.input group -->
    </div>
    <!-- /.form group -->
