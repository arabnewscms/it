...
<div class="' . $data['col_width'] . '">
    <div class="form-group">
        ...
        <div class="col-md-12">
            {!! Form::color(\'{Convention}\', {Convention2} ,[\'class\'=>\'form-control\',\'placeholder\'=>trans(\'{lang}.{Convention}\')]) !!}
        </div>
    </div>
</div>
';
...
<div class="' . $data['col_width'] . '">
    <div class="form-group">
        ...
        <div class="col-md-12">
            <input type="color" id="{Convention}" name="{Convention}" value="{{ {Convention2} }}" class="form-control" placeholder="{{trans(\'{lang}.{Convention}\')}}" />
        </div>
    </div>
</div>
';
