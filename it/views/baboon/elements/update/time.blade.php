...
<div class="bootstrap-timepicker">
  <div class="form-group">
    ...
    <div class="input-group date timepicker" id="timepicker" data-target-input="nearest">
      {!! Form::text(\'{Convention}\',{Convention2},[\'class\'=>\'form-control datetimepicker-input\',\'placeholder\'=>trans(\'{lang}.{Convention}\'),"data-target"=>".timepicker","readonly"=>"readonly"]) !!}
...
<div class="bootstrap-timepicker">
  <div class="form-group">
    ...
    <div class="input-group date timepicker" id="timepicker" data-target-input="nearest">
      <input type="time" id="{Convention}" name="{Convention}" value="{{ {Convention2} }}" class="form-control datetimepicker-input" data-target=".timepicker" readonly  placeholder="{{trans(\'{lang}.{Convention}\')}}" />
      <div class="input-group-append" data-target=".timepicker" data-toggle="datetimepicker">
          <div class="input-group-text"><i class="far fa-clock"></i></div>
      </div>
      </div>
