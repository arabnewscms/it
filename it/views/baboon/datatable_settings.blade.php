        ...
        <div class="row">
          <div class="table-responsive" dir="rtl">
            <div id="dataTableBuilder_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="dt-buttons btn-group flex-wrap">
              <button class="btn btn-secondary buttons-print {{ datatable_check('datatable_print')[1] }} datatable_print"  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-print"></i> Print</span>
              </button>
              <button class="btn btn-secondary datatable_xlxs {{ datatable_check('datatable_xlxs')[1] }} buttons-excel "  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-file-excel"></i> Export Excel</span>
              </button>
              <button class="btn btn-secondary datatable_pdf {{ datatable_check('datatable_pdf')[1] }} buttons-pdf"  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-file-pdf"></i> Export  PDF</span>
              </button>
              <button class="btn btn-secondary buttons-csv {{ datatable_check('datatable_csv')[1] }} datatable_csv"  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-file-excel"></i> Export CSV</span>
              </button>
              <button class="btn btn-secondary buttons-reload {{ datatable_check('datatable_reload')[1] }} datatable_reload"  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-sync-alt"></i> Reload</span>
              </button>
              <button class="btn btn-secondary  {{ datatable_check('datatable_delete')[1] }} datatable_delete deleteBtn"  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-trash"></i> Delete</span>
              </button>
              <button class="btn btn-secondary {{ datatable_check('datatable_add')[1] }} datatable_add btn-primary"  aria-controls="dataTableBuilder" type="button"><span><i class="fa fa-plus"></i> Create</span>
              </button>
            </div>
            <div class="clearfix"></div>
            <div class="dataTables_length {{ datatable_check('datatable_lengthmenu')[1] }} datatable_lengthmenu col-md-2" id="dataTableBuilder_length">
              <label>show
                <select name="dataTableBuilder_length" aria-controls="dataTableBuilder" class="custom-select custom-select-sm form-control pull-left  form-control-sm">
            ...
            <div class="col-md-10 datatable_searching {{ datatable_check('datatable_searching')[1] }}">
              <label>search<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTableBuilder"></label>
            </div>
            <table class="table table-striped table-bordered table-hover table-checkable dataTable no-footer" id="dataTableBuilder" role="grid" aria-describedby="dataTableBuilder_info">
              <thead>
                <tr role="row" class="">
                  <th width="10px" class="datatable_checkbox {{ datatable_check('datatable_checkbox')[1] }}" rowspan="1" colspan="1" style="width: 37px;" aria-label="">
                    <div class="icheck-danger">
                      <input type="checkbox" class="select-all" id="select-all">
                      <label for="select-all"></label>
                    </div>
                  </th>
                  <th title="Record id" width="10px" class="datatable_record_id {{ datatable_check('datatable_record_id')[1] }}"  aria-controls="dataTableBuilder" rowspan="1" colspan="1" style="width: 24px;" aria-sort="descending" aria-label="">Record id</th>
                  <th title="Title" class="sorting"  aria-controls="dataTableBuilder" rowspan="1" colspan="1" style="width: 197px;" aria-label="">Title
                  </th>
                  <th title="created at" class="datatable_created_at {{ datatable_check('datatable_created_at')[1] }}" rowspan="1" colspan="1" style="width: 234px;" aria-label="created at">
                    created at
                  </th>
                  <th title="Updated at" class="datatable_updated_at {{ datatable_check('datatable_updated_at')[1] }}" rowspan="1" colspan="1" style="width: 201px;" aria-label="Updated at">
                    Updated at
                  </th>
                  <th title="Action" class="datatable_action {{ datatable_check('datatable_action')[1] }}" rowspan="1" colspan="1" style="width: 113px;" aria-label="Action">
                    Action
                  </th>
                </tr>
              </thead>
              ...
              <tr>
                ...
                <th rowspan="1" colspan="1" class="datatable_record_id {{ datatable_check('datatable_record_id')[1] }}">
            ...
            <div class="dataTables_info" id="dataTableBuilder_info" role="status" aria-live="polite">Empty Table</div>
            <div class="datatable_paging {{ datatable_check('datatable_paging')[1] }}">
              <ul class="pagination">
                <li class="paginate_button page-item previous disabled" id="dataTableBuilder_previous">
                  <a href="#" aria-controls="dataTableBuilder" class="page-link">Previous</a>
                </li>
                <li class="paginate_button page-item next disabled" id="dataTableBuilder_next">
                  <a href="#" aria-controls="dataTableBuilder"  class="page-link">Next</a>
                </li>
              </ul>
            </div>
          </div>
